...
<%
String sql =" select ifnull( max(student_no),180000)+1 student_no from student_tbl_15; ";
  ...
  <form name="frm" method="post" action="studentWriteSave.jsp">
	...
	<table border="1" align="center" >
		...
		<tr>
			...
			<td>
			<input type="checkbox" name="student_status" value="1">재학
		...
		<tr>
			...
			<td><input type="text" name="student_addr" style="width:300px"></td>
		</tr>
		...
		<input type="button" value="조회" onClick="location='studentList.jsp'">
		</td>
		</tr>
	</table>
