...
String sql = " select title,name,content,rdate from reboard ";
...
<html lang="ko">
  ...
  <body>
    ...
    <div id="jb-container">  <!-- container 전체를 감쌈-->
     ...
     <form name="frm" method="post" action="replyWriteSave.jsp"> <!-- 모든데이터를 --로 이동시킴 -->
     ...
     <table class="table1">
     	...
     	<tr>
     		...
     		<td class="td1">[답변]<input type="text" name="title" value="<%=title %>" style="width:200px"></td> <!-- 객체삽입 -->
     	</tr>
     	...
     	<tr>
     		<th class="td1">내용</th>
     		<td class="td1"><textarea name="content" style="width:99%;height:70px;"></textarea></td> <!-- 텍스트에어리어 사이에 객체삽입 -->
     	</tr>
