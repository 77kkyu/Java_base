...
stmt.executeUpdate("update reboard set hit=hit+1 where unq='"+unq+"' ");



String sql = " select title,name,content,date_format(rdate,'%Y년%m월%d일%k시%i분%s초') as rdate from reboard ";
...
<html lang="ko">
  ...
  function fn_delete(){
	  ...
	  location="passWrite.jsp?unq=<%=unq%>&gubun=R";                 
  }
         /* ? = get방식 */
  </script>
  ...
  <body>
    ...
    <div id="jb-container">  <!-- container 전체를 감쌈-->
     ...
     <table class="table1">
     	...
     	<tr>
     		<th colspan="2">
     		<input type="button" value="수정" onClick="location='rBoardModify.jsp?unq=<%=unq%>'"> <!-- unq값을 가지고 이동  -->
     		<input type="button" value="삭제" onClick="fn_delete()">
     		<input type="button" value="답변" onClick="location='replyWrite.jsp?unq=<%=unq%>'">
     		</th>
     	</tr>
