...
String sql = " select p_name, p_price, p_info, p_date, company, manager_id ";
  ...
  <form name="frm" method="post" action="modifySave.jsp">
	...
	<table border="1" align="center" width="500">
		...
		<tr height="70">
			...
			<td><textarea name="p_info" style="width:60%;height:70px;" ><%=p_info %></textarea></td>
		</tr>
		<tr>
			<th colspan="2" style="background:#ffff00;">등록일자</th>
			<td><input type="text" name="p_date" value="<%=p_date %>"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="manager_id" value="<%=manager_id %>"></td>
		</tr>
	...
	<br>
    	<div  align="center">    	
		<td colspan="2">
		<input type="submit" value="수정확인" onClick="fn_action(); return false;">
